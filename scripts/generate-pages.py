#!/usr/bin/env python3
"""Generate SEO landing pages for Stratos Environmental Ltd."""
import os
...
<header class="site-header"><div class="container"><nav class="nav" id="nav">
  ...
  <ul class="nav-links">
    ...
    <li class="nav-mobile-only"><a href="{prefix}index.html#coverage">Areas</a></li>
    <li class="nav-mobile-only"><a href="{prefix}index.html#faq">FAQs</a></li>
    <li class="nav-mobile-only"><a href="{prefix}portal.html">Order sacks</a></li>
    <li class="nav-mobile-only"><a href="{prefix}upload-invoice.html">Upload invoice</a></li>
  </ul>
  <div class="nav-actions">
    ...
    <a class="nav-call-icon" href="tel:+447448730416" aria-label="Call Stratos on +44 7448 730416"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg></a>
    <a href="{prefix}quote.html" class="btn btn-primary">Free Quote</a>
    <button class="nav-toggle" id="navToggle" aria-label="Menu" aria-expanded="false" aria-controls="nav"><span></span><span></span><span></span></button>
  </div>
</nav></div></header>"""
...
# --- SERVICES ---
services = [
    ("commercial-waste-collection", "Commercial Waste Collection UK | Stratos Environmental Ltd",
    ...
    ("general-waste", "General Waste Collection for Businesses | Stratos Environmental Ltd",
    ...
    ("dry-mixed-recycling", "Dry Mixed Recycling Collection | Stratos Environmental Ltd",
    ...
    ("clinical-waste", "Clinical Waste Collection | Stratos Environmental Ltd",
    ...
    ("confidential-waste", "Confidential Waste Collection | Stratos Environmental Ltd",
    ...
    ("hazardous-waste", "Hazardous Waste Collection | Stratos Environmental Ltd",
    ...
    ("wheelie-bin-collection", "Commercial Wheelie Bin Collection | Stratos Environmental Ltd",
    ...
    ("skip-hire", "Commercial Skip Hire | Stratos Environmental Ltd",
...
for slug, title, desc, eyebrow, h1, lead, body, qp, rel in [
    ("food-waste-collection", "Food Waste Collection for Businesses | Stratos Environmental Ltd",
    ...
    ("glass-recycling", "Glass Recycling for Businesses | Stratos Environmental Ltd",
    ...
    ("commercial-recycling", "Commercial Recycling Services | Stratos Environmental Ltd",
...
# --- INDUSTRIES ---
industries = [
    ("restaurant-waste-collection", "Restaurant Waste Collection London | Stratos Environmental Ltd",
    ...
    ("pub-waste-collection", "Pub Waste Collection London | Stratos Environmental Ltd",
    ...
    ("cafe-waste-collection", "Café Waste Collection London | Stratos Environmental Ltd",
    ...
    ("hotel-waste-collection", "Hotel Waste Collection London | Stratos Environmental Ltd",
     ...
     "", [("services/commercial-waste-collection.html", "Commercial waste")]),
    ("gym-waste-collection", "Gym Waste Collection London | Stratos Environmental Ltd",
     ...
     "", [("industries/office-waste-collection.html", "Office waste")]),
    ("office-waste-collection", "Office Waste Collection London | Stratos Environmental Ltd",
    ...
    ("dental-waste-collection", "Dental Waste Collection London | Stratos Environmental Ltd",
    ...
    ("school-waste-collection", "School Waste Collection London | Stratos Environmental Ltd",
    ...
    ("retail-waste-collection", "Retail Waste Collection London | Stratos Environmental Ltd",
    ...
    ("warehouse-waste-collection", "Warehouse Waste Collection London | Stratos Environmental Ltd",
...
# --- LONDON AREAS ---
areas = [
    ("commercial-waste-london", "Commercial Waste Collection London | Stratos Environmental Ltd",
     ...
     "<p>Stratos Environmental Ltd is a London-based commercial waste broker. We compare quotes from licensed partners across every borough.</p><h2>Industries we serve</h2><ul><li>Restaurants, pubs and cafés</li><li>Offices and retail</li><li>Hotels and hospitality</li><li>Healthcare and dental</li></ul>",
     "", [("industries/restaurant-waste-collection.html", "Restaurant waste"), ("services/commercial-waste-collection.html", "Services")]),
    ("commercial-waste-wandsworth", "Commercial Waste Wandsworth | Stratos Environmental Ltd",
     ...
     "<p>Businesses in Wandsworth can save by comparing waste providers through Stratos Environmental Ltd. We cover SW18 and surrounding areas.</p>",
     "", [("areas/commercial-waste-london.html", "London")]),
    ("commercial-waste-putney", "Commercial Waste Putney | Stratos Environmental Ltd",
    ...
    ("commercial-waste-battersea", "Commercial Waste Battersea | Stratos Environmental Ltd",
     ...
     "", [("areas/commercial-waste-london.html", "London")]),
    ("commercial-waste-clapham", "Commercial Waste Clapham | Stratos Environmental Ltd",
    ...
    ("commercial-waste-chelsea", "Commercial Waste Chelsea | Stratos Environmental Ltd",
     ...
     "", [("areas/commercial-waste-london.html", "London")]),
    ("commercial-waste-fulham", "Commercial Waste Fulham | Stratos Environmental Ltd",
    ...
    ("commercial-waste-richmond", "Commercial Waste Richmond | Stratos Environmental Ltd",
     ...
     "", [("areas/commercial-waste-london.html", "London")]),
    ("commercial-waste-wimbledon", "Commercial Waste Wimbledon | Stratos Environmental Ltd",
     ...
     "", [("areas/commercial-waste-wandsworth.html", "Wandsworth")]),
    ("commercial-waste-westminster", "Commercial Waste Westminster | Stratos Environmental Ltd",
    ...
    ("commercial-waste-camden", "Commercial Waste Camden | Stratos Environmental Ltd",
...
# --- BLOG ---
blogs = [
    ("commercial-waste-collection-cost", "How Much Does Commercial Waste Collection Cost? | Stratos Environmental Ltd",
    ...
    ("how-to-switch-waste-providers", "How to Switch Waste Providers | Stratos Environmental Ltd",
     ...
     "<p>Many businesses overpay because switching feels complicated. Here's how to do it smoothly.</p><h2>Steps to switch</h2><ol><li>Check your current contract end date and notice period</li><li>Get comparison quotes (we can do this for you)</li><li>Give notice to your current supplier</li><li>Arrange bin delivery and first collection with your new provider</li></ol><h2>We can help</h2><p>Stratos Environmental Ltd compares providers and handles the setup through our licensed partner network. Upload your invoice or request a free quote.</p>",
     "", [("quote.html", "Get a quote")]),
    ("wheelie-bin-size-guide", "What Size Wheelie Bin Do I Need? | Stratos Environmental Ltd",
    ...
    ("restaurant-waste-regulations", "Commercial Waste Regulations for Restaurants | Stratos Environmental Ltd",
     ...
     "<p>UK restaurants must use licensed waste carriers and keep waste transfer notes. Since 2023, many businesses must separate food waste from general waste.</p><h2>Key requirements</h2><ul><li>Use a registered waste carrier</li><li>Keep Duty of Care documentation for 2 years</li><li>Separate food waste where required</li><li>Store waste safely before collection</li></ul><p>All collections arranged through Stratos Environmental Ltd use licensed, compliant partners.</p>",
     "", [("industries/restaurant-waste-collection.html", "Restaurant waste")]),
    ("best-waste-company-london", "How to Find the Best Waste Company in London | Stratos Environmental Ltd",
